...
def fit_ae(model, mode=None, tr_data=None, val_data=None, num_epochs=20, bs=32, lr=0.1, momentum=0., **kwargs):
    """
    ...
    criterion = ContractiveLoss(ae=model, lambd=0) if mode == 'contractive' else nn.MSELoss()
    if mode == 'denoising':
